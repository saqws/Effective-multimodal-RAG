...
if __name__ == "__main__":
    # a = iter(create_multimodal_dataloader("../data/COCO", "T-I", dataset_percents=0.001, batch_size=1))
    dataloader = create_multimodal_dataloader("../data/COCO", "T-I", dataset_percents=0.001, batch_size=2, shuffle=True)
    for i in dataloader:
        print(i)
        # pixels = 0
        # for batch in i["neg_images"]:
            # for image in batch:
                # pixels += image.size[0] * image.size[1]
        # print("Pixels=", pixels)
        break
    # dataloader = create_multimodal_dataloader("../data/COCO", "T-I", dataset_percents=0.0001, batch_size=32)
    # for i in dataloader:
        # pixels = 0
        # for batch in i["neg_images"]:
            # for image in batch:
    ...
    # for batch in a:
        ...
        # for i in range(len(batch)):
            # sample = batch[i]
            # for neg_image in sample["neg_images"]:
                # print("Image: i, size: ", neg_image.size)
