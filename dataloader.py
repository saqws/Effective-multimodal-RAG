...
def create_multimodal_dataloader(
    ...
    dataset_percents: float = 1.0,
    val_split: float = 0.1,  # <--- добавлено
) -> tuple[DataLoader, DataLoader]:
    """Создает DataLoader'ы для мультимодального поиска (train и val)"""

    # Выбор класса датасета
    ...
    # collate_fn одинаков для train/val
